...
public class ShortCommentExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handle(ShortCommentApplicationException e) {
        HttpStatus status = switch (e.getErrorCode()) {
            case INVALID_INPUT_VALUE, CANNOT_REPORT_OWN_COMMENT -> HttpStatus.BAD_REQUEST;
            case BANNED_USER_ACCESS, NOT_COMMENT_OWNER -> HttpStatus.FORBIDDEN;
            case SHORT_NOT_FOUND, PARENT_COMMENT_NOT_FOUND, COMMENT_NOT_FOUND -> HttpStatus.NOT_FOUND;
