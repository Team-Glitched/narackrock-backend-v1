...
public class TrackCreateUseCase {
    ...
    public TrackCreateUseCase(ProjectRepositoryPort projects, ProjectMemberRepositoryPort members,
                              ProjectTrackRepositoryPort tracks, UserRepositoryPort users) {
