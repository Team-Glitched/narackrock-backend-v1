...
public class UserBanCancelUseCase {
    ...
    private UserBanCancelResponse executeInTransaction(
            UserBanCancelRequest request
    ) {
        if (request == null
        ...
        UserBan activeBan = userBanRepository
                .findActiveByUserId(request.userId(), now)
